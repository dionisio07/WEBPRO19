...
<head>
  ...
  <link rel="shortcut icon" href="YOUR_CODE_HERE">
  <meta charset="utf-8">
...
<nav class="navbar navbar-red navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      <a class="navbar-brand" href="#"><img src="<?php echo base_url().'assets/img/logo.png';?>" height="30" width="30" /></a>
    </div>
